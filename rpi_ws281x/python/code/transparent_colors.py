...
L = 90  # <- dimensions of the final picture

# 1,1,1,0 for transparency
surface = gz.Surface(78, 90, bg_color=(1, 1, 1))  # <- white background
...
surface.write_to_png("assets/transparent_colors.png")
